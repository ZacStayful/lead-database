    ...
    switch (event.type) {
      ...
      case "customer.subscription.deleted": {
        ...
        if (isGuaranteedRent) {
          ...
          //
          // ONE EXCEPTION, ADDED IN 0086: a self-serve tier change made from the
          ...
          // invisible to admin (0086). OBSERVABILITY ONLY: deliberately no
      ...
      case "invoice.paid": {
        ...
        if (subscriptionId) {
          ...
          if (isGuaranteedRent) {
            ...
            // for it (0086). The dashboard route swaps the Stripe price with no
          ...
          // A self-serve tier change lands HERE (0086), for the reason the GR
